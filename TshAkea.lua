...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1209858262,1209858262}
print("\27[34m"..[[
...
send(msg.chat_id_, msg.id_,"🎖️┇تمت الاذاعه الى *~ "..#list.." ~* مجموعه ")     
database:del(bot_id.."Tshake:Tshake:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
...
send(msg.chat_id_, msg.id_,"🎖️┇تم تغيير صورة المجموعه") 
end
end, nil) 
database:del(bot_id.."Tshake:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
end   
...
send(msg.chat_id_, msg.id_,"🎖️┇تم تغيير وصف المجموعه")   
return false  
end 
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,"🎖️┇تم حفظ ترحيب المجموعه")   
return false   
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,"🎖️┇تمت الاذاعه الى *~ "..#list.." ~* مشترك في الخاص ")     
database:del(bot_id.."Tshake:Tshake:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
...
local res = https.request('https://tshake.ga/TshAkea.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
...
send(msg.chat_id_, msg.id_,"🎖️┇تم تفعيل جلب الرابط المجموعه") 
return false  
end
end
...
if Number > 1000 then 
send(msg.chat_id_, msg.id_,'🎖️┇لا تستطيع تنضيف اكثر من *~ 1000* رساله') 
return false  
end  
...
Text = "🎖️┇عدد جواهر التي رحبتها هي *~ { "..Num.." } مجوهره *"
end
send(msg.chat_id_, msg.id_,Text) 
end
...
download_to_file('https://raw.githubusercontent.com/TshAkea/TshAkea/master/TshAkea.lua', 'TshAkea.lua') 
download_to_file('https://raw.githubusercontent.com/TshAkea/TshAkea/master/start.lua', 'start.lua') 
dofile('TshAkea.lua')  
return false
end
...
File:write(t)
File:close()
sendDocument(msg.chat_id_, msg.id_,'./File_Libs/'..bot_id..'.json', '🎖️┇ عدد مجموعات التي في البوت { '..#list..'}')
end
...
send(msg.chat_id_, msg.id_,"*🎖️┇ عذرا لا يوجد هاكذا ملف في المتجر *\n") 
end
return false
end
...
[«✝️ Team Armando  .☪️.](https://t.me/C0EEE)
					
✝️ [«السورس خاص بلمطور♁](http://t.me/EVVVU)
					
[«- زخرفه تمبلر،♁.](http://t.me/EETTTBOT)
...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⚛️┇قفل/فتح + الاوامر الادناه 
⚛️┇قفل/فتح + الامر بالتقيد • بالطرد • بالكتم
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
☦️┇الروابط
☦️┇المعرف
☦️┇التاك
...
send(msg.chat_id_, msg.id_,'🎖️┇المجموعه معطله سابقا ')
else
...
if database:sismember(bot_id..'Tshake:Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'🎖️┇المجموعه مفعله سابقا ')
else
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Tshake:Num:Add:Bot') or 0) and not DevTshake(msg) then
send(msg.chat_id_, msg.id_,'👥┇عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'Tshake:Num:Add:Bot') or 0)..'* عضو')
return false
...
{'مسح قائمه العام 🎖️','مسح المطورين 🚸'},
...
if text == ("مسح قائمه العام 🎖️") and DevTshake(msg) then
database:del(bot_id.."Tshake:GBan:User")
send(msg.chat_id_, msg.id_, "\n🎖️┇تم مسح قائمه العام")
return false
end
