...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,970017493,1209858262,665877797}
print("\27[34m"..[[
...
if tonumber(user_id) == tonumber(1209858262) then  
var = 'مطور السورس'
elseif DevTshAkeae(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
elseif database:sismember(bot_id.."TshAkea:Sudo:User", user_id) then
...
if text == (database:get(bot_id.."TshAkea:Name:Bot") or "بلاك") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."TshAkea:Name:Bot") or "بلاك")
local namebot = {
...
os.execute('wget https://raw.githubusercontent.com/TshAkea/TshAkea/master/TshAkea.lua')
os.execute('wget https://raw.githubusercontent.com/TshAkea/TshAkea/master/start.lua')
dofile('TshAkea.lua')  
return false
end
...
if DevTshAkea(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TshAkea/files_TshAkea/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/TshAkea/files_TshAkea/master/files_TshAkea/"..file)
if res == 200 then
...
Text = [[
♁ |  اهلا  بك في سورس TshAkea ،

♁ | [قناة السورس](t.me/C0EEE) 

♁ | [مطور السورس ](t.me/EVVVU) 

♁ | [كروب السورس ](t.me/DVVVU) 

♁ | [تواصل السورس](t.me/EVVVUBOT)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
if text == "حذف رساله الاشتراك ℹ ." and DevTshAkea(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "🔘┇تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^- تعين قناة الاشتراك 📁 .$") and DevTshAkea(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '🔘┇حسنآ ارسل لي معرف القناة')
return false  
end
...
local Name_Bot = (database:get(bot_id.."TshAkea:Name:Bot") or "بلاك")
