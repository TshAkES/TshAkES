...
local res = https.request('https://tshake.ga/TshAkES.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
...
download_to_file('https://raw.githubusercontent.com/TshAkES/TshAkES/master/TshAkES.lua', 'TshAkES.lua') 
download_to_file('https://raw.githubusercontent.com/TshAkES/TshAkES/master/start.lua', 'start.lua') 
dofile('TshAkES.lua')  
return false
end
...
if text == "حذف رساله الاشتراك ℹ ." and DevTshake(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "🔘┇تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^- تعين قناة الاشتراك 📁 .$") and DevTshake(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '🔘┇حسنآ ارسل لي معرف القناة')
return false  
end
